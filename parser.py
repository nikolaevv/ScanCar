...
url = 'https://auto.ru/-/ajax/desktop/cardGroupOffers/'
...
payload = {"category": "cars", "output_type":"list", "section":"new", "page":0,"geo_radius":200, "geo_id":[213]}
...
for brand in brands:
    ...
    while page < 20:
        ...
        payload['page'] = page
        print(brand[0].lower())
        payload['catalog_filter'] = [{"mark": brand[0].lower(), "model": brand[1].lower()}]
        headers['Referer'] = 'https://auto.ru/cars/new/group/{}/{}/21719392-21719435/?do_not_redirect=true&page={}'.format(brand[0], brand[1], page)
