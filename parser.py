...
payload = {"category": "cars", "section":"new", "page":0,"geo_radius":200, "geo_id":[213]}
...
for brand in brands:
    ...
    while True:
        ...
        payload['page'] = page
        headers['Referer'] = 'https://auto.ru/moskva/cars/audi/new/?output_type=list&page={}'.format(page)
